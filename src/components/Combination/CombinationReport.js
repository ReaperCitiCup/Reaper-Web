          ...
          <div className="report">
            <div className={styles.report_body}>
              ...
              <div className={styles.section_11}>
                ...
                <p>
                  <span>部分因子暴露计算方法及构成</span>
                  <br/>
                  动量计算方法及构成：超额收益<br/>
                  流动性计算方法及构成：月度平均换手率、3个月平均换手率、12个月平均换手率<br/>
                  杠杆率计算方法及构成：市场杠杆、负债／资产、账面杠杆<br/>
                  成长性计算方法及构成：3年盈利增长率预测（长期）、1年盈利增长率预测（短期）、过去5年增长率（长期）、过去5年销售收入增长率（长期）<br/>
                  价值计算方法及构成：市净值倒数
                  <br/><br/>
                </p>
              </div>
...
function mapStateToProps(state) {
  return {
    ...
    backtestSuccess: state.combination.backtestSuccess,
